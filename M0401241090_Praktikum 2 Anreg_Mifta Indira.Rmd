...
data <- read_excel("C:\\Users\\MIFTA INDIRA\\OneDrive\\Documents\\INDIRA\\IPB University\\Semester 4\\Analisis Regresi\\NSC-2025.xlsx", sheet="Sheet3")
...
Misal ingin dilakukan eksplorasi dan analisis terkait peubah X7
...
Didapatkan nilai $\hat\beta_0 = -10.70937$ artinya nilai dugaan rataan indeks pembangunan manusia ketika indeks pembangunan gender bernilai bernilai 0 persen adalah -10.709%, akan tetapi nilai 0 tidak ada dalam selang pengamatan rata-rata lama sekolah sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut.

Nilai $\hat\beta_1 = 0.93703$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika Indeks Pembangunan Gender berubah satu tahun adalah sebesar 0.937%.

Koefisien determinasi yang dihasilkan adalah 0.5108 atau 51.08% artinya keragaman persentase penduduk miskin yang dapat dijelaskan oleh persentase akses sanitasi layak adalah sebesar 51.08%, sisanya yaitu 48.92% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
